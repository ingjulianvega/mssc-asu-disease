...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(DiseaseParameters diseaseParameters) {
        this.diseaseParameters = diseaseParameters;
    }
    ...
    public ResponseEntity<ApiError> validationErrorHandler(DiseaseException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(diseaseParameters.getApi())
